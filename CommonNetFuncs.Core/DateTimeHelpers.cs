...
public static class DateTimeHelpers
{
	...
	/// <returns>The number of business days between <paramref name="startDate"/> and <paramref name="endDate"/></returns>
...
#pragma warning restore S6562 // Provide the "DateTimeKind" when creating this object.
	...
	/// <returns><see langword="true"/> if double passed in represents a valid OA Date</returns>
	public static bool IsValidOaDate(this double? oaDate)
	{
		return oaDate is >= 657435.0 and <= 2958465.99999999;
	}
