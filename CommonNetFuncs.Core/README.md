...
- [CommonNetFuncs.Core](#commonnetfuncscore)
  ...
  - [Strings](#strings)
    - [Strings Usage Examples](#strings-usage-examples)
      ...
      - [JoinStringsAsWrittenList](#joinstringsaswrittenlist)
...
Removes newline characters from a string to prevent log forging when logging user-supplied values.

```cs
"line1\nline2".SanitizeForLog(); // "line1 line2"
"line1\r\nline2".SanitizeForLog(); // "line1  line2"
```

#### JoinStringsAsWrittenList

Joins a collection of strings into a written list, using commas and "and" as appropriate.

```cs
((IEnumerable<string>?)null).JoinStringsAsWrittenList(); // null
new List<string>().JoinStringsAsWrittenList(); // null
new List<string> { "Apple" }.JoinStringsAsWrittenList(); // "Apple"
new List<string> { "Apple", "Banana" }.JoinStringsAsWrittenList(); // "Apple and Banana"
new List<string> { "Apple", "Banana", "Cherry" }.JoinStringsAsWrittenList(); // "Apple, Banana, and Cherry"
```
