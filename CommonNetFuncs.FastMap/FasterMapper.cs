...
// 	public static TDest? FasterMap<TSource, TDest>(this TSource source) where TSource : class? where TDest : class?
// 	{
// 		if (source is null)
// 		{
// 			return default;
...
// 	/// <returns>New instance of TDest with values populated from source object</returns>
// 	[return: NotNullIfNotNull(nameof(source))]
// 	public static TDest? FasterMap<TSource, TDest>(this TSource source, bool useCache) where TSource : class? where TDest : class?
// 	{
// 		if (source is null)
// 			return default;
