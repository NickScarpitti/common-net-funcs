# CommonNetFuncs.Ffmpeg

[![License](https://img.shields.io/github/license/NickScarpitti/common-net-funcs.svg)](http://opensource.org/licenses/MIT)
[![NuGet Version](https://img.shields.io/nuget/v/CommonNetFuncs.Ffmpeg)](https://www.nuget.org/packages/CommonNetFuncs.Ffmpeg/)
[![nuget](https://img.shields.io/nuget/dt/CommonNetFuncs.Ffmpeg)](https://www.nuget.org/packages/CommonNetFuncs.Ffmpeg/)

This project contains helper methods using Xabe.FFMpeg including file conversion and video metadata extraction.

## Contents

- [CommonNetFuncs.Ffmpeg](#commonnetfuncsffmpeg)
  - [Contents](#contents)
...
```bash
dotnet add package CommonNetFuncs.Ffmpeg
```
