...
public sealed class CacheOptions
{
    ...
    public HashSet<string> HeadersToCache { get; set; } = DefaultHeadersToCache;
...
public static class CacheOptionDefaults
{
    ...
    public static readonly HashSet<string> DefaultHeadersToCache = new(StringComparer.OrdinalIgnoreCase)
    {
        "Content-Type",
        "Content-Language",
        "Content-Encoding",
