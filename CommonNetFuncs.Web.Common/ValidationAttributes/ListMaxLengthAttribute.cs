...
public sealed class ListMaxLengthAttribute : ValidationAttribute
{
	...
	/// </summary>
	/// <param name="length">
	/// The maximum allowable length of collection/string data. Value must be greater than zero.
	/// </param>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="MaxLengthAttribute" /> class. The maximum allowable length supported by the database will be used.
	/// </summary>
	[RequiresUnreferencedCode(CountPropertyHelper.RequiresUnreferencedCodeMessage)]
