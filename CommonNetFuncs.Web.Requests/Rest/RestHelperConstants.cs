...
public static class RestHelperConstants
{
	...
	public static readonly IImmutableDictionary<string, string> MemPackHeaders = ImmutableDictionary.CreateRange(new[] { MemPackContentHeader, MemPackAcceptHeader });
	public static readonly IImmutableDictionary<string, string> MsgPackHeaders = ImmutableDictionary.CreateRange(new[] { MsgPackContentHeader, MsgPackAcceptHeader });
	public static readonly IImmutableDictionary<string, string> JsonHeaders = ImmutableDictionary.CreateRange(new[] { JsonContentHeader, JsonAcceptHeader });
	public static readonly IImmutableDictionary<string, string> JsonNoEncodeHeaders = ImmutableDictionary.CreateRange(new[] { JsonContentHeader, JsonAcceptHeader, NoEncodingHeader });
}
