...
public sealed class CollectionsTests
{
	...
	public void GetObjectByPartial_WithDateTimeOffsetSameInstant_MatchesCorrectly()
	{
		...
		// Act
		TestEntityWithDateTimeOffset? result = context.TestEntitiesWithDateTimeOffset.GetObjectByPartial(context, partialObject, true, TestContext.Current.CancellationToken);
	...
	public void GetObjectByPartial_WithAllPropertiesDefault_ReturnsNullWhenIgnoringDefaults()
	{
		...
		// Act
		TestEntity? result = context.TestEntities.GetObjectByPartial(context, partialObject, ignoreDefaultValues: true, TestContext.Current.CancellationToken);
	...
	public async Task GetObjectByPartialAsync_WithAllPropertiesDefault_ReturnsNullWhenIgnoringDefaults()
	{
		...
		// Act
		TestEntity? result = await context.TestEntities.GetObjectByPartialAsync(context, partialObject, ignoreDefaultValues: true, TestContext.Current.CancellationToken);
	...
	public void GetObjectByPartial_WithSqlServerProvider_NormalizesDateTimeToUnspecified()
	{
		...
		try
		{
			TestEntity? result = sqlContext.TestEntities.GetObjectByPartial(sqlContext, partialObject, true, TestContext.Current.CancellationToken);
		}
	...
	public void GetObjectByPartial_WithSqliteProvider_NormalizesToUtc()
	{
		...
		// Act
		TestEntity? result = sqliteContext.TestEntities.GetObjectByPartial(sqliteContext, partialObject, true, TestContext.Current.CancellationToken);
	...
	public async Task GetObjectByPartialAsync_WithSqliteProvider_NormalizesToUtc()
	{
		...
		using TestDbContext sqliteContext = new(options);
		await sqliteContext.Database.OpenConnectionAsync(TestContext.Current.CancellationToken);
		await sqliteContext.Database.EnsureCreatedAsync(TestContext.Current.CancellationToken);
		...
		// Act
		TestEntity? result = await sqliteContext.TestEntities.GetObjectByPartialAsync(sqliteContext, partialObject, true, TestContext.Current.CancellationToken);
	...
	public void GetObjectByPartial_WithPropertyNotInMetadata_NormalizesToUtc()
	{
		...
		TestEntityNotInModel? result = queryable.GetObjectByPartial(context, partialObject, true, TestContext.Current.CancellationToken);
