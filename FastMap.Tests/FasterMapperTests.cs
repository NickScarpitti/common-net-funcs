...
public sealed class FasterMapperTests
{
	...
	{
		// Act
		int[] result = source.FasterMap<int[], int[]>();
		...
		string? nestedString, int? nestedInt, int[]? numberSet, string? queueItem, double? stackItem)
	{
		...
		// Act
		NullableComplexDestination result = source.FasterMap<NullableComplexSource, NullableComplexDestination>();
	...
	public void FasterMap_WithReadOnlyCollections_MapsCorrectly(int[] numbers, string[] strings)
	{
		...
		// Act
		ReadOnlyCollectionDest result = source.FasterMap<ReadOnlyCollectionSource, ReadOnlyCollectionDest>();
	...
	public void FasterMap_WithCustomCollections_MapsCorrectly(int[] sourceData)
	{
		...
		// Act
		CustomCollectionDest result = source.FasterMap<CustomCollectionSource, CustomCollectionDest>();
	...
	public void FasterMap_BetweenDifferentCollectionTypes_MapsCorrectly(int[] sourceData)
	{
		...
		List<int> listResult = sourceData.FasterMap<int[], List<int>>();
		listResult.ShouldBe(sourceData);

		// Act & Assert - List to Array
		int[] arrayResult = listSource.FasterMap<List<int>, int[]>();
		arrayResult.ShouldBe(listSource);

		// Act & Assert - HashSet to List
		List<int> listFromHashSet = hashSetSource.FasterMap<HashSet<int>, List<int>>();
			...
			string name, int age, string? extraProperty)
	{
		...
		// Act
		DestWithMismatchedProperties result = source.FasterMap<SourceWithMismatchedProperties, DestWithMismatchedProperties>();
	...
	public void FasterMap_WithNestedDictionary_MapsCorrectly(string key1Str, int key1Int, string? key2Str, int? key2Int)
	{
		...
		// Act
		DictionaryDest result = source.FasterMap<DictionarySource, DictionaryDest>();
	...
	public void FasterMap_WithInvalidDictionaryMapping_ThrowsException()
	{
		...
		Exception? exception = Should.Throw<TypeInitializationException>(() => source.FasterMap<Dictionary<int, string>, List<string>>());
	...
	public void FasterMap_WithMismatchedDictionaryKeyTypes_ThrowsException()
	{
		...
		// Act & Assert
		// FasterMapper uses static generic class cache, so exception is wrapped in TypeInitializationException
		Exception? exception = Should.Throw<TypeInitializationException>(() => source.FasterMap<Dictionary<int, string>, Dictionary<string, string>>());
		exception.InnerException.ShouldNotBeNull();
	...
	public void FasterMap_CacheIsReused_MapsConsistently(string stringProp, int intProp)
	{
		...
		SimpleDestination result1 = source.FasterMap<SimpleSource, SimpleDestination>();
		SimpleDestination result2 = source.FasterMap<SimpleSource, SimpleDestination>();
		SimpleDestination result3 = source.FasterMap<SimpleSource, SimpleDestination>();
	...
	public void FasterMap_WithNullableStringProperty_MapsCorrectly(string? stringProp)
	{
		...
		// Act
		NullableSimpleDestination result = source.FasterMap<NullableSimpleSource, NullableSimpleDestination>();
