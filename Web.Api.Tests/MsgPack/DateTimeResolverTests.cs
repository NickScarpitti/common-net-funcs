...
public sealed class DateTimeStringResolverTests
{
	...
	[Fact]
	public void GetFormatter_DateOnly_ReturnsDateOnlyAsStringFormatter()
	{
		IMessagePackFormatter<DateOnly>? formatter = DateTimeStringResolver.Instance.GetFormatter<DateOnly>();
		formatter.ShouldBeOfType<DateOnlyAsStringFormatter>();
	}
