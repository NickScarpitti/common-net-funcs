...
public sealed class JwtManagerTests
{
    ...
    public void Authenticate_WithVariousCredentials_ReturnsExpectedResult(string? username, string? password,
        string actualUsername, string actualPassword, bool shouldSucceed)
    {
        // Arrange
