...
public class JsonPatchFormatterTests
{
    ...
    public void JsonPatchInputFormatter_ShouldHave_DefaultContractResolver()
    {
        ...
        PropertyInfo? serializerSettingsProperty = formatter.GetType()
            .GetProperty("SerializerSettings", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public);
